...
// Mock PermissionSlipService
vi.mock('@tripslip/database', () => ({
  PermissionSlipService: vi.fn(() => ({
    generatePermissionSlips: vi.fn(() => Promise.resolve({
      totalGenerated: 0,
      totalSkipped: 0,
      errors: []
    }))
...
describe('RosterManager - Basic Functionality', () => {
  ...
  it('renders action buttons', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('Generate Slips')).toBeDefined();
    });
  });
